...
public class HtmlParser {
  ...
  private static final String HTML_TOP_LINE = "<tr>\n" +
      "    <td class=\"topcol\">Server</td>\n" +
      "    <td class=\"topcol\">Response, ms</td>\n" +
      "   </tr>\n" ;
   ...
   * @param maxResult - max result to be red
   * @return - return Html page in String
   */
  public String parseToTablePage(List<Result> listOfResults, Result maxResult) {
    String resultOfParse = HTML_START_OF_PAGE + HTML_TOP_LINE;
    for (Result result: listOfResults) {
      resultOfParse += !result.equals(maxResult) ?
          createLine(HTML_COL_START , result.getServerAddress(),
              result.getResponse() + "", HTML_COL_END) :
          createLine(HTML_COL_RED_START , result.getServerAddress(),
              result.getResponse() + "", HTML_COL_END);
    }
   ...
   */
  private String createLine (String start, String textFirstColumn, String textSecondColumn, String end) {
