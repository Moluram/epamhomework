...
public class HtmlParser {
  ...
  private static final String HTML_TOP_LINE = "<tr>\n" +
      ...
      "    <td class=\"topcol\">Cost</td>\n" +
      "    <td class=\"topcol\">Time</td>\n" +
      "   </tr>\n" ;
  ...
  public String getResultsInHtmlTableForm(List<Result> listOfResults) {
    ...
    for (Result result: listOfResults) {
      resultOfParse += createLine(HTML_COL_START , result.getTypeOfTransport().getSimpleName(),
          result.getCost().setScale(20, RoundingMode.HALF_UP).toString(),
          result.getTime().setScale(20, RoundingMode.HALF_UP).toString(), HTML_COL_END);
    }
  ...
  private String createLine (String start, String textFirstColumn, String textSecondColumn,
                             String textThirdColumn, String end) {
